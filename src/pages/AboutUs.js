...
function aboutUs() {
  return (
    <Container className={styles.Content}>
      ...
      <p className={styles.Paragraph}>Join us on the cosmic journey and be part of a community that reaches for the stars. Together, we can uncover the mysteries of the universe and share the joy of stargazing with the world.</p>
      <div>

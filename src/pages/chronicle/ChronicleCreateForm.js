...
function ChronicleCreateForm() {
  ...
  const { title, description, image, author, published_on, image_copyright, category } = chronicleData;
  ...
  const textFields = (
    <div className="text-center">
      ...
      <Form.Group>
        ...
        <Form.Control type="date" name="published_on" value={published_on} onChange={handleChange} />
      </Form.Group>
            ...
            <Form.Group className="text-center">
              {image ? (
                ...
                <Form.Label className="d-flex justify-content-center" htmlFor="image-upload">
                  <Asset src={Upload} message="Click the astronaut to upload an image" />
                </Form.Label>
              )}
